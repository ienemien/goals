	...
	<table class="table table-striped">
		...
		<tbody class="goal" ng-hide="loading" ng-repeat="goal in goals">
			...
			<form>
				...
				<td><input type="text" class="form-control input-sm" name="title" value="{{ goal.title }}"></td>
				<td><input type="checkbox" name="done" ng-checked="{{ goal.done }}"></td>
				<td><button class="btn btn-primary" href="#" ng-click="updateGoal(goal)" class="text-muted">Save</a></td>
			</form>
